(function() {
    ...
    r("Promise", function(a) {
        ...
        b.all = function(f) {
            ...
            return h.done ? d([]) : new b(function(l, m) {
                ...
                var w = [],
                    A = 0;
                do w.push(void 0), A++, d(h.value).B(u(w.length - 1), m), h = e.next(); while (!h.done)
            })
        };
        return b
    });
    ...
    r("Map", function(a) {
        ...
        function d(e, h) {
            var l = h && typeof h;
            l == "object" || l == "function" ? g.has(h) ? l = g.get(h) : (l = "" + ++f, g.set(h, l)) : l = "p_" + h;
            var m = e[0][l];
            if (m && G(e[0], l))
        ...
        k.prototype.forEach = function(e, h) {
            for (var l = this.entries(), m; !(m = l.next()).done;) m = m.value, e.call(h, m[1], m[0], this)
        };
    ...
    r("Array.from", function(a) {
        return a ? a : function(b, c, d) {
            ...
            if (typeof g == "function") {
                ...
                for (g = b.length, f = 0; f < g; f++) k.push(c.call(d, b[f], f));
            return k
        }
    });
    /*
    ...
    */
    ...
    var ta = Array.prototype.indexOf ? function(a, b) {
        ...
        ua = Array.prototype.forEach ? function(a, b, c) {
            ...
            for (var d = a.length, k = typeof a === "string" ? a.split("") : a, g = 0; g < d; g++) g in k && b.call(c, k[g], g, a)
        };
    ...
    */
    ...
    function eb() {
        ...
        else b = (S().indexOf("Chrome") != -1 || S().indexOf("CriOS") != -1) && (cb() || S().indexOf("Edge") == -1) || S().indexOf("Silk") != -1;
    ...
    n.F = function(a) {
        ...
        if (b) {
            var c = this.h[b];
            this.m != 0 ? (this.l.push(a), this.g[a + 1] = function() {}) : (c && va(c, a), delete this.g[a], delete this.g[a + 1], delete this.g[a + 2])
        }
        return !!b
    };
    n.G = function(a, b) {
        ...
        if (c) {
            ...
            if (this.A)
                for (g = 0; g < c.length; g++) k = c[g], hb(this.g[k + 1], this.g[k + 2], d);
            else {
                this.m++;
                try {
            ...
            switch (c.g) {
                ...
                case 2:
                    ...
                    return C(c, Promise.all(b.map(function(d) {
                        var k;
                        return F(function(g) {
                            if (g.g == 1) return g.l = 2, C(g, navigator.permissions.query({
                                name: "top-level-storage-access",
                                requestedOrigin: d
                            }), 4);
                            g.g != 2 ? (k = g.m, k.state === "prompt" && a.g.push(d), g.g = 0, g.l = 0) : (g.l = 0, g.i = null, g.g = 0)
                        })
                    })), 4);
                case 4:
    ...
    function Fb(a, b, c) {
        Z || (Z = {}, Jb = new Set, Lb.addEventListener("message", function(d) {
            a: if (Jb.has(d.origin)) {
                ...
                var g = Z[k.id];
                if (g && d.origin === g.O) switch (d = g.U, d.m = !0, d.m && (ua(d.l, d.sendMessage, d), d.l.length = 0), g = k.event, k = k.info, g) {
                    case "apiInfoDelivery":
                        if (I(k))
                            for (var f in k) k.hasOwnProperty(f) && (d.v[f] = k[f]);
                        break;
                    case "infoDelivery":
                        Hb(d, k);
                        break;
                    case "initialDelivery":
                        I(k) && (clearInterval(d.h), d.playerInfo = {}, d.v = {}, Ib(d, k.apiInterface), Hb(d, k));
                        break;
