(() => {
    ...
    function r(e, t, r) {
        ...
        }(t, "string"), (t = "symbol" == n(a) ? a : String(a)) in e ? Object.defineProperty(e, t, {
            value: r,
            enumerable: !0,
            configurable: !0,
            writable: !0
        ...
        window.fluentFormrecaptchaSuccessCallback = function(e) {
            ...
            function(e, r) {
                ...
                window.fluentFormApp = function(t) {
                    ...
                    if (!s) return console.log("No Fluent form JS vars found!"), !1;
                    if (a[i]) return a[i];
                    var c, l, u, d, h, p, m, g, v, _, w, y, b, k, C, S, j, x, T, O, A, Q, F, P, N = s.form_id_selector,
                        I = "." + i;
                    return c = o, l = {}, u = function() {
                        ...
                        try {
                            ...
                            if (r.each(e.find("[type=file]"), (function(e, t) {
                                    var n = {},
                                        a = t.name + "[]";
                                    n[a] = [], r(t).closest("div").find(".ff-uploaded-list").find(".ff-upload-preview[data-src]").each((function(e, t) {
                                        n[a][e] = r(this).data("src")
                                    })), r.each(n, (function(e, t) {
                                        if (t.length) {
                                            var n = {};
                                            n[e] = t, o.data += "&" + r.param(n)
                                        }
                                    }))
                        ...
                        var a, i, o = (a = "t=" + Date.now(), i = e.ajaxUrl, i += (i.split("?")[1] ? "&" : "?") + a);
                        if (!this.isSending) {
                            var f, c = this;
                            this.isSending = !0, r.post(o, n).then((function(n) {
                                if (!n || !n.data || !n.data.result) return t.trigger("fluentform_submission_failed", {
                                    form: t,
                                    response: n
                                }), void C(n);
                                if (f = n, n.data.append_data && F(n.data.append_data), n.data.nextAction) t.trigger("fluentform_next_action_" + n.data.nextAction, {
                                    form: t,
                                    response: n
                                });
                                else {
                                    if (t.triggerHandler("fluentform_submission_success", {
                                        ...
                                        role: "status",
                                        "aria-live": "polite"
                                    }).html(n.data.result.message).insertAfter(t).focus(), t.find(".ff-el-is-error").removeClass("ff-el-is-error")), void(location.href = n.data.result.redirectUrl);
                                    var a = N + "_success",
                                        i = "#" + a;
                                    r(i).length && r(i).slideUp("fast"), r("<div/>", {
                                        id: a,
                                        class: "ff-message-success",
                                        role: "status",
                                        "aria-live": "polite"
                                    }).html(n.data.result.message).insertAfter(t).focus(), t.find(".ff-el-is-error").removeClass("ff-el-is-error"), "hide_form" == n.data.result.action ? (t.hide().addClass("ff_force_hide"), t[0].reset()) : (jQuery(document.body).trigger("fluentform_reset", [t, s]), t[0].reset());
                                    var o = r(i);
                                ...
                                if (t.trigger("fluentform_submission_failed", {
                                    ...
                                    if (f = r, r.responseJSON.append_data && F(r.responseJSON.append_data), C(r.responseJSON.errors), y(350), t.find(".fluentform-step").length) {
                                    ...
                                    v(t)
                                } else C(r.responseText)
                            })).always((function(e) {
                                var r;
                                if (c.isSending = !1, null === (r = f) || void 0 === r || null === (r = r.data) || void 0 === r || null === (r = r.result) || void 0 === r || !r.hasOwnProperty("redirectUrl")) {
                                    if (v(t), window.grecaptcha) {
                        ...
                        "yes" != t.attr("data-ff_reinit") && (r(document).on("submit", I, (function(e) {
                            ...
                            ! function(n) {
                                r(".ff-step-body", t).length && h(0, e.stepAnimationDuration, !1), n.find(".ff-el-repeat .ff-t-cell").each((function() {
                        ...
                        e && (r.isEmptyObject(e) || (r.each(e, (function(e, a) {
                            "string" == typeof a && (a = [a]), r.each(a, (function(a, i) {
                                var o = r("<div/>", {
                                        class: "error text-danger"
                                    }),
                                    f = r("<span/>", {
                                ...
                                o.attr("role", "alert"), o.append(s, f), r(document.body).trigger("fluentform_error_in_stack", {
                                    form: t,
                                    element: T(e),
                                    message: s
                                }), n.append(o).show()
                            ...
                            r(this).closest("div").remove(), n.hide()
                        ...
                        var a, i;
                        (a = T(e)).length ? (a.attr("aria-invalid", "true"), (i = r("<div/>", {
                            class: "error text-danger"
                        })).attr("role", "alert"), a.closest(".ff-el-group").addClass("ff-el-is-error"), a.closest(".ff-el-input--content").length ? (a.closest(".ff-el-input--content").find("div.error").remove(), r(document.body).trigger("fluentform_error_below_element", {
                            form: t,
                            element: a,
                            message: n
                        }), a.closest(".ff-el-input--content").append(i.html(n))) : (a.find("div.error").remove(), a.append(i.text(n)))) : S([n])
                    }, x = function() {
                        ...
                        if (a) try {
                            ...
                            console.error("Error resetting ".concat(e, ":"), r), t.removeAttr(n).removeData("".concat(e, "-rendered"))
                        }
                        return !1
                    }, F = function(e) {
                        ...
                        initFormHandlers: function() {
                            _(), d(), x(), t.removeClass("ff-form-loading").addClass("ff-form-loaded"), t.on("show_element_error", (function(e, t) {
                        ...
                        initTriggers: function() {
                            t = u(), jQuery(document.body).trigger("fluentform_init", [t, s]), jQuery(document.body).trigger("fluentform_init_" + s.id, [t, s]), t.trigger("fluentform_init_single", [this, s]), t.find("input.ff-el-form-control").on("keypress", (function(e) {
                                return 13 !== e.which
                            })), t.data("is_initialized", "yes"), t.find("input.ff-read-only").each((function() {
                                r(this).attr({
                                    tabindex: "-1",
                                    readonly: "readonly"
                                })
                                ...
                                }).appendTo(document.body), a = r(".ff-el-pop-content")), n = n.replace(/<script[\s\S]*?>[\s\S]*?<\/script>/gi, "").replace(/<iframe[\s\S]*?>[\s\S]*?<\/iframe>/gi, "").replace(/<.*?\bon\w+=["'][^"']*["']/gi, "").replace(/javascript:/gi, ""), a.html(n);
                        ...
                        addFieldValidationRule: function(e, t, r) {
                            s.rules[e] || (s.rules[e] = {}), s.rules[e][t] = r
                        },
                ...
                var i = {
                        init: function() {
                            ...
                            setTimeout((function() {
                                e.initMultiSelect()
                            }), 100), this.initMask(), this.initNumericFormat(), this.initCheckableActive(), this.maybeInitSpamTokenProtection(), this.maybeHandleCleanTalkSubmitTime()
                        },
                        maybeInitSpamTokenProtection: function() {
                            ...
                            jQuery("form.frm-fluent-form").each((function(t, r) {
                                ...
                                if (0 !== a.length && !n.hasClass("ff_tokenizing") && !n.hasClass("ff_tokenized")) {
                                    var i = function() {
                                        n.hasClass("ff_tokenized") || n.hasClass("ff_tokenizing") || (n.addClass("ff_tokenizing"), e.generateAndSetToken(n, a))
                                    };
                        ...
                        generateAndSetToken: function(t, r) {
                            ...
                            jQuery.post(o, {
                                ...
                                e.success && e.data.token ? (r.val(e.data.token), t.addClass("ff_tokenized")) : (r.val(null), console.error("Token generation failed for form ID:", i))
                            })).fail((function(e, n, o) {
                                console.error("Error generating token for form ID:", i, o), a && setTimeout((function() {
                        ...
                        return new function() {
                            this.errors = {}, this.validate = function(e, t) {
                                var n, a, i = this,
                                    o = !0;
                                e.each((function(e, f) {
                                    n = r(f), a = n.prop("name").replace("[]", ""), "repeater_item" !== n.data("type") && "repeater_container" !== n.data("type") || (a = n.attr("data-name"), t[a] = t[n.data("error_index")]), t[a] && r.each(t[a], (function(e, t) {
                ...
                r.each(f, (function(e, t) {
                    ...
                    var n = r(t),
                        a = fluentFormApp(n);
                    if (!a) return !1;
                    a.reinitExtras(), s(n), i.init(), n.attr("data-ff_reinit", "yes")
                })), i.init()
